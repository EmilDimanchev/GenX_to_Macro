...
macro_case_path = genx_case_path*"/macro_inputs";
...
system = MacroEnergy.load_system(macro_case_path; lazy_load=true)
...
mkpath(results_dir)
MacroEnergy.write_capacity(joinpath(results_dir, "capacity.csv"), system)
MacroEnergy.write_costs(joinpath(results_dir, "costs.csv"), system, model)  
