                ...
                "edges" => Dict(
                    "elec_edge" => merge!(
                        Dict(
                            ...
                            "ramp_down_fraction" => gen(y).ramp_dn_percentage,
                            "ramp_up_fraction" => gen(y).ramp_up_percentage,
                            "variable_om_cost" => round(gen(y).var_om_cost_per_mwh, digits=3),
                            "min_down_time" => gen(y).down_time,
                            "min_up_time" => gen(y).up_time,
                            "startup_cost" => gen(y).start_cost_per_mw,
                ...
                "edges" => Dict(
                    "elec_edge" => merge!(
                        Dict(
                            ...
                            "min_capacity" => 0,
                            "min_flow_fraction" => gen(y).min_power,
                            "ramp_down_fraction" => 0.36, # Cheng 2024 preprint for inflexible
                            "ramp_up_fraction" => 0.36, # Cheng 2024 preprint for inflexible
                            "variable_om_cost" => gen(y).var_om_cost_per_mwh,
                            "min_down_time" => 18, # Cheng 2024 preprint for inflexible
                            "min_up_time" => 12, # Cheng 2024 preprint for inflexible
                            "startup_cost" => 159, # Cheng 2024 preprint for inflexible
                            "startup_fuel_consumption" => round(conv_mmbtu_to_mwh * gen(y).start_fuel_mmbtu_per_mw, digits=3),
                            "wacc" => wacc,
                            "capital_recovery_period" => crp,
                            "lifetime" => lifetime,
